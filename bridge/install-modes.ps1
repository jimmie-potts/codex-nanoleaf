...
foreach ($name in @('tray-icon.ico', 'tray-icon.ps1', 'integration_api.py', 'controller_state.py', 'controller_contract.py', 'controller_server.py', 'requirements-controller.txt', 'devices.py', 'project_map.py', 'shared_input.py', 'wall_server.py', 'wall.html', 'prism.js', 'prism-adapters.js', 'prism-labels.js', 'bridge.py', 'tray.ps1', 'remove-modes.ps1', 'backup_install.py', 'install-modes.ps1', 'README.md')) {
