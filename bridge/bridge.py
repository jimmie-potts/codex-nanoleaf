...
def setup(args):
    ...
    if Path(__file__).resolve() != installed_script.resolve():
        ...
        for name in ('project_map.py', 'wall_server.py', 'wall.html', 'prism.js', 'prism-adapters.js', 'tray.ps1', 'remove-modes.ps1', 'install-modes.ps1', 'backup_install.py', 'controller_state.py', 'controller_server.py', 'controller_contract.py', 'requirements-controller.txt', 'README.md'):
