...
Switch layouts from the map's Options menu, the `style` command or the legacy
tray. Mode, layout, colors, reservations, half choices, map orientation, and
animation coverage survive restarts. Classic keeps
