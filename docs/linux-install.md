...
choice and defers hosting off WSL to the hub. Opening any WSL session, including
a Codex Desktop task running in WSL, starts the distribution and its services.
