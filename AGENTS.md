...
- When drafting or picking up a story, or after a material scope change, apply the [scope defaults](docs/sdlc.md#scope-defaults), including in ordinary work without `plan-work` or `deliver-work`. A read-only request reports the assessment without writing.
