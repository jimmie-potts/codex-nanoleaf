...
The wall SHALL preserve keyboard focus, Ctrl/Command/Shift multi-selection, task/project/inspector associations, selection and pending rings, explicit Locate, and Classic/Project allocation semantics. The renderer SHALL NOT add state or device writes. Existing number identification SHALL remain available pending issue #26. Covers AC6.
