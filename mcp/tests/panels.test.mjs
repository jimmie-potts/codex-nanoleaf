...
const LINES_TOOLS = ['nanoleaf_status', 'nanoleaf_mode_set', 'nanoleaf_scenes_list', 'nanoleaf_scene_activate', 'nanoleaf_animations_list', 'nanoleaf_animation_play','nanoleaf_scene_restore'];
