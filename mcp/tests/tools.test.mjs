...
test('fixed tools delegate status and preserve exact mode identity',async()=>{
 ...
 assert.deepEqual(tools.map(t=>t.name),['nanoleaf_status','nanoleaf_mode_set','nanoleaf_scenes_list','nanoleaf_scene_activate','nanoleaf_animations_list','nanoleaf_animation_play']);
