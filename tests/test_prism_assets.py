...
class PrismAssetTest(unittest.TestCase):
    ...
    def test_copied_wall_runs_in_a_foreground_process_without_device_or_windows_helpers(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            for name in ('bridge.py','devices.py','panels.py','project_map.py','shared_input.py','wall_server.py','integration_api.py', 'controller_state.py','controller_contract.py','wall.html','prism.js','prism-adapters.js','prism-labels.js'):
