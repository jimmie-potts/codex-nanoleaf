...
for(const name of ['shared_metadata','compact_tasks','current_projects','line_identity','foundation','presentation','assembly','prism_coverage','prism_lifecycle','label_clearance']){
