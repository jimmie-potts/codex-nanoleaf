...
for(const name of ['codex_links','eviction','shared_metadata','compact_tasks','current_projects','line_identity','foundation','hierarchy','presentation','assembly','prism_coverage','prism_lifecycle','label_clearance']){
